...
const Table : Bootstrap.TableModule.TableProps = {
    size: 'sm',
    head: [{
            title: 'First Name',
        }, {
    ...
    body: [[{
            title: 'First Name',
            value: <span>James</span>
        }, {
            title: 'Last Name',
            value: 'Matman'
        }],[{
            title: 'First Name',
            value: <span>Jokey</span>
        }, {
            title: 'Last Name',
            value: 'Smurf'
        }]
    ],
    page: Bootstrap.TableModule.GetNumberTablePagination(1, 10, 2, 5, undefined, (event) => {console.log(event)}),
};

const Sidebar : Bootstrap.SidebarModule.SidebarProps = {
    default: {
        modules: [{
            number: 1, 
            name: 'Home2',
...
const Root = (
    <React.Fragment>
        ...
        <Bootstrap.Footer {...Footer}></Bootstrap.Footer>
    </React.Fragment>
);
